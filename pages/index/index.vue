	...
	<view class="outer">
		...
		<view class="doc-bar">
			<scroll-view scroll-x="true" class="doc-list">
				<view v-for="doc in docList" :key="doc.filename"
					:class="['doc-item', currentDoc === doc.filename ? 'doc-item-active' : '']"
					@click="currentDoc = doc.filename">
					{{ doc.filename }}
					<text class="doc-delete" @click.stop="handleDeleteDoc(doc.filename)">×</text>
				</view>
			</scroll-view>
